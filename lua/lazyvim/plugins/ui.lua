  ...
  -- the "LAZYVIM" banner.
  {
    ...
    opts = function()
      ...
      dashboard.section.buttons.val = {
        dashboard.button("e", " " .. " File explorer", ":Neotree current toggle reveal_force_cwd <CR>"),
        dashboard.button("n", " " .. " New file", ":ene <BAR> startinsert <CR>"),
        dashboard.button("r", " " .. " Recent files", ":Telescope oldfiles <CR>"),
        dashboard.button("g", " " .. " Find text", ":Telescope live_grep <CR>"),
        dashboard.button("p", " " .. " Plugins", ":e ~/.config/nvim/lua/lazyvim/plugins <CR>"),
        dashboard.button("k", " " .. " Keybindings", ":e ~/.config/nvim/lua/lazyvim/config/keymaps.lua <CR>"),
        dashboard.button("o", " " .. " Options", ":e ~/.config/nvim/lua/lazyvim/config/options.lua <CR>"),
