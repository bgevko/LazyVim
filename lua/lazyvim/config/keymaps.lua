...
map("n", "<leader>m", ":Alpha<CR>", { desc = "Open menu" })

-- Paste over currently selected text without yanking it
map("v", "p", '"_dP', { desc = "Paste without yanking" })

-- Remove yanking from some commands
...
map("n", "<leader><Down>", "<C-W>s", { desc = "Split window below", remap = true })
map("n", "<leader><Right>", "<C-W>v", { desc = "Split window right", remap = true })
